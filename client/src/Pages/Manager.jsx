...
const Manager = () => {
  return (
    <div
      id="manager"
      className=" mx-4 py-2 px-3 rounded-2xl shadow-lg shadow-gray-300 border-2 border-gray-300"
    >
      <p className="text-md font-semibold ml-2 mb-1">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex flex-col  w-2/4 place-items-end">
          ...
          <p className="text-lg text-gray-400 font-semibold ">Income</p>
